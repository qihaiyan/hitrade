      ...
      <header className="p-4 flex items-center bg-gray-800 text-white shadow-lg">
        ...
        <h1 className="ml-4 text-xl font-semibold">
          <Link to="/" className="flex items-center">
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 496 512" width="24" height="24" className="h-10 motion-safe:animate-spin text-cyan-600 dark:text-cyan-500" xmlns="http://www.w3.org/2000/svg" style={{ animationDuration: '10s', animationTimingFunction: 'ease-in-out' }}>
